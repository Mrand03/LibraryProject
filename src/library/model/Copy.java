...
public class Copy implements java.io.Serializable {
    ...
    public SimpleDate renew() throws IllegalArgumentException
    {
        if (this.getCheckedOutTo() == null)
        {
            throw new IllegalArgumentException("This" + this.getItem().toString() + " isn't checked out ");
        }
        else if (this.daysOverdue() != 0)
        {
            throw new IllegalArgumentException("This" + this.getItem().toString() + " is overdue.");
        }
        else if(renewalCount == this.getItem().getAllowedNumberOfRenewals())
        {
            throw new IllegalArgumentException("This" + this.getItem().toString() + " can't be renewed again");
        }
        else if(this.getItem().getAllowedNumberOfRenewals() == 0)
        {
            throw new IllegalArgumentException("This" + this.getItem().toString() + " is not allowed for renewal");
        }
        else
        {
